...
{
    public class BuscarComprobantesPorRfcEmitdoQueryHandler : IRequestHandler<BuscarComprobantesPorRfcEmitdoQuery, IEnumerable<ComprobanteAddDto>>
    {
        ...
        public async Task<IEnumerable<ComprobanteAddDto>> Handle(BuscarComprobantesPorRfcEmitdoQuery request, CancellationToken cancellationToken)
        {
