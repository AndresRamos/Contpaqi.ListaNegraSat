...
{
    public class Contribuyente69BDto
    {
        public string Numero { get; set; }
        public string Rfc { get; set; }
        public string NombreContribuyente { get; set; }
        public string Situacion { get; set; }
        public string NumeroYFechaDeOficioGlobalDePresuncion { get; set; }
        ...
        public string NumeroYFechaDeOficioGlobalDeContribuyentesQueDesvirtuaron { get; set; }
        public string PublicacionDofDesvirtuados { get; set; }
        public string NumeroYFechaDeOficioGlobalDeDefinitivos { get; set; }
        public string PublicacionPaginaSatDefinitivos { get; set; }
        public string PublicacionDofDefinitivos { get; set; }
        public string NumeroYFechaDeOficioGlobalDeSentenciaFavorable { get; set; }
