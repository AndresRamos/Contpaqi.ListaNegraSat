...
namespace ListaNegraSat.Presentation.WpfApp.ViewModels.Expedientes
{
    public sealed class ExpedientesListaViewModel : Screen
    {
        ...
        public BindableCollection<ExpedienteAddDto> Expedientes { get; } = new BindableCollection<ExpedienteAddDto>();
        ...
        public async Task ExportarExcelAsync()
        {
            ...
            try
            {
                ...
                {
                    var excelWorksheet = excelPackage.Workbook.Worksheets.Add("Expedientes");
