...
public sealed class Articulo69BListadoCompletoViewModel : Screen
{
    ...
    public BindableCollection<Contribuyente69BDto> Contribuyentes { get; } = new();
    ...
    public async Task BuscarContribuyentesAsync()
    {
        ...
        try
        {
            Articulo69BListadoCompleto listado =
                await _mediator.Send(new BuscarContribuyentes69BQuery(
